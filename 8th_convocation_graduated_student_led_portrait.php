...
<div class="flex min-h-screen w-full items-center overflow-hidden justify-center bg-gray-100 bg-gradient-to-r from-orange-100 to-blue-100">
  <div class="flex w-full flex-col items-center justify-center gap-2 sm:gap-4 fade-in-left">
    ...
    <div class="z-10 mb-2 flex items-center justify-center px-2">
      <img src="/img/logo-2.png" alt="Southeast University Logo" class="h-28" />
    </div>

    <div class="relative z-10 grid grid-cols-1 sm:w-4/5 h-full md:h-[1000px] overflow-hidden rounded-[40px] bg-white p-2 sm:p-6 mx-2 shadow-lg" id="profile-card">

      <!-- Left Side Graduate Image -->
      <div class="md:col-span-5 flex flex-col items-center justify-center">
        <div class="flex items-center justify-center">
          <img id="student-picture" src="img/8th_convocation_logo.png" alt="Graduate Image" class="h-[400px] w-[350px] rounded-full border-gray-300 fade-in-animation" />
        </div>
      </div>
...
<script type="text/javascript" src="js/custom_led_portrait.js"></script>
</body>
