...
<body class="bg-gray-100">
    ...
    <section class="convocation-section py-28 md:py-40 bg-gray-100 dark:bg-gray-900 relative overflow-hidden" data-aos="fade-up">
        ...
        <div class="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <header class="mb-16">
                <p class="text-base font-semibold tracking-widest uppercase [color:rgb(232_109_61/var(--tw-text-opacity))] dark:[color:rgb(210_95_50/var(--tw-text-opacity))]">
                    A Defining Moment
                </p>
                <h2 class="text-6xl lg:text-7xl font-black text-gray-900 dark:text-white mt-1" data-aos="fade-right" data-aos-delay="150">
                    ...
                    <span class="[color:rgb(232_109_61/var(--tw-text-opacity))] dark:[color:rgb(210_95_50/var(--tw-text-opacity))]">
                        6<sup class="text-4xl align-super">th</sup>
                    </span>
    ...
    <div class="p-8 bg-gradient-to-br from-orange-800 via-orange-600 to-yellow-400 rounded-2xl shadow-2xl w-full h-full flex flex-col justify-between self-stretch border-4 border-white dark:border-white-700 relative overflow-hidden">
        ...
        <div class="mt-auto pt-8 border-t-2 border-white/30 flex flex-col items-center">
            ...
            <span class="mt-4 text-white font-bold text-lg tracking-wide drop-shadow">6th Convocation</span>
                ...
                <div class="lg:col-span-8" data-aos="fade-left" data-aos-delay="400">
                    ...
                    <h3 class="text-3xl font-bold [color:rgb(44_181_188/var(--tw-text-opacity))] dark:[color:rgb(38_160_165/var(--tw-text-opacity))] mb-6 border-b-2 border-gray-300 dark:border-gray-700 pb-3">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 program-list">
                        ...
                        <li data-aos="fade-up" data-aos-delay="500">
                            <a href="#gold-medalists"
                                class="flex items-center p-5 rounded-lg [background-color:rgb(220_106_50/var(--tw-bg-opacity))] dark:[background-color:rgb(214_90_32/var(--tw-bg-opacity))] text-white font-medium shadow-xl transition duration-300 transform hover:scale-[1.02] hover:[background-color:rgb(255_127_70/var(--tw-bg-opacity))] hover:[color:rgb(23_23_23/var(--tw-text-opacity))] group">
                                 <!-- Using SVG for Medal Icon -->
                                <span class="group-hover:text-gray-900 mr-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" 
                                        fill="currentColor" class="w-8 h-8 text-[#cebd00] transition-all duration-300 group-hover:text-gray-900">
                        ...
                        <li data-aos="fade-up" data-aos-delay="600">
                            <a href="#messages"
                                ...
                                <!-- Using SVG for Speech Icon -->
                                    <span class="text-[#cebd00] group-hover:text-gray-900 mr-4 text-3xl transition-all duration-300 ease-in-out">
                        ...
                        <li data-aos="fade-up" data-aos-delay="700">
                            <a href="#committee"
                                ...
                                <!-- Using SVG for Committee Icon -->
                                 <span class="text-[#cebd00] group-hover:text-gray-900 mr-4 text-3xl">
                        ...
                        <li data-aos="fade-up" data-aos-delay="800">
                            <a href="/souvenir/6th-Convocation.php" target="_blank" rel="noopener noreferrer"
                                 class="flex items-center p-5 rounded-lg [background-color:rgb(220_106_50/var(--tw-bg-opacity))] dark:[background-color:rgb(214_90_32/var(--tw-bg-opacity))] text-white font-extrabold shadow-xl transition duration-300 transform hover:scale-[1.02] hover:[background-color:rgb(255_127_70/var(--tw-bg-opacity))] hover:[color:rgb(23_23_23/var(--tw-text-opacity))] group">
        ...
        <div class="container mx-auto max-w-7xl">
            ...
            <div class="message-card-grid">
                ...
                include './data/6th_convocation_data.php';
                $delay = 0;
        ...
        <div class="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
                ...
                <div class="lg:col-span-2 order-2 lg:order-1" data-aos="fade-right" data-aos-delay="300">
                    ...
                    <p class="text-xl text-gray-700 dark:text-gray-400 max-w-2xl mb-10 leading-relaxed">
        ...
        <div class="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <header class="text-center mb-16">
                ...
                <h2 class="text-5xl lg:text-6xl font-extrabold text-gray-800 dark:text-white mt-1" data-aos="fade-down" data-aos-delay="150">
                    The <span class="inline-flex items-start"><span>6</span><sup class="text-2xl ml-0.5">th</sup></span> Convocation
                </h2>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
                ...
                <div class="lg:col-span-1" data-aos="fade-right" data-aos-delay="300">
                    <div class="p-8 border-l-4 [border-color:rgb(185_178_64)] bg-gray-50 dark:bg-gray-800 shadow-lg rounded-lg h-full">
                        <h3 class="text-3xl font-serif font-bold text-gray-900 dark:text-white mb-4">
                            Date of Ceremony
                        </h3>
                        <p class="text-4xl font-extrabold text-orange-500 mb-6 border-b pb-3 border-gray-200 dark:border-gray-700">
                            27th February, 2024
                        </p>
                ...
                <div class="lg:col-span-1 flex justify-center order-first lg:order-none p-4" data-aos="zoom-in" data-aos-delay="400">
                    <img src="./img/All convocation logo/6th.png" alt="6th Convocation Logo"
                        class="w-full max-w-sm rounded-full border-8 border-gray-200 dark:border-gray-700 shadow-2xl transition duration-500 ease-in-out hover:border-cyan-500 bg-white dark:bg-gray-800 p-2"
                ...
                <div class="lg:col-span-1" data-aos="fade-left" data-aos-delay="500">
                    ...
                    <ul class="space-y-3 program-list">
                        ...
                        <li data-aos="zoom-in" data-aos-delay="900" class="pt-4">
                            <a href="/souvenir/8th-Convocation.php" target="_blank" rel="noopener noreferrer"
                                class="block w-full text-center py-4 rounded-lg [background-color:rgb(44_181_188)] hover:[background-color:rgb(185_178_64)] transition duration-300 font-semibold text-white shadow-md transform hover:-translate-y-1">
