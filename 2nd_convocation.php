        ...
        <div class="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
                ...
                <div class="lg:col-span-8" data-aos="fade-left" data-aos-delay="400">
                    ...
                    <h3 class="text-3xl font-bold [color:rgb(27_111_130/var(--tw-text-opacity))] dark:[color:rgb(23_92_108/var(--tw-text-opacity))] mb-6 border-b-2 border-gray-300 dark:border-gray-700 pb-3">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 program-list">
                        ...
                        <li data-aos="fade-up" data-aos-delay="500">
                            <a href="#gold-medalists"
                                 class="flex items-center p-5 rounded-lg [background-color:rgb(220_20_64/var(--tw-bg-opacity))] dark:[background-color:rgb(200_17_53/var(--tw-bg-opacity))] text-white font-medium shadow-xl transition duration-300 transform hover:scale-[1.02] hover:[background-color:rgb(247_17_63/var(--tw-bg-opacity))] hover:[color:rgb(23_23_23/var(--tw-text-opacity))] group">
                        ...
                        <li data-aos="fade-up" data-aos-delay="800">
                            <a href="/souvenir/2nd-Convocation.php" target="_blank" rel="noopener noreferrer"
                               class="flex items-center p-5 rounded-lg [background-color:rgb(220_20_64/var(--tw-bg-opacity))] dark:[background-color:rgb(200_17_53/var(--tw-bg-opacity))] text-white font-extrabold shadow-xl transition duration-300 transform hover:scale-[1.02] hover:[background-color:rgb(247_17_63/var(--tw-bg-opacity))] hover:[color:rgb(23_23_23/var(--tw-text-opacity))] group">
    ...
    <section class="premium-messages-section" id="messages">
        <div class="container mx-auto max-w-7xl">
            ...
            <div class="message-card-grid">
                ...
                include './data/2nd_convocation_data.php';
                $delay = 0;
        ...
        <div class="container mx-auto max-w-7xl">
            ...
            <div id="tab-contents">
                <div class="tab-content" id="chancellor">
                    ...
                    <div class="section-divider">
                        <h3 class="text-2xl font-bold text-gray-700 text-center mb-4">Dean's Gold Medalists</h3>
                        <div class="gradient-divider"></div>
                        <div class="card-grid">
                            <?php
                            include './data/2nd_convocation_data.php';
    ...
    <section class="committee-section-v3" id="committee">
        <div class="container mx-auto max-w-7xl">
            ...
            <div class="committee-group-v3">
                <h3 class="committee-heading-v3">Organizing & Reception Committee</h3>
                <div class="committee-grid-v3">
                    <?php
                    include './data/2nd_convocation_data.php';


                    foreach ($Organizing_Reception_Committee as $member) {
                        echo '
            ...
            <div class="committee-group-v3">
                <h3 class="committee-heading-v3">Sub-Committee for Invitation, Souvenir, Message, Convocation, Speech & Printing</h3>
                <div class="committee-grid-v3">
                    <?php
                    include './data/2nd_convocation_data.php';


                    foreach ($Sub_Committee_for_Invitation_Souvenir_Message_Convocation_Speech_Printing as $member) {
                        echo '
                    <div class="committee-card-v3">
                        <img class="committee-img-v3" src="' . $member['img'] . '" alt="' . $member['name'] . '">
                        <div class="card-content-v3">
            ...
            <div class="committee-group-v3">
                <h3 class="committee-heading-v3">Sub-Committee for Convocation Dress,Venue, Transport, Logistics,Gift, Crest,Gold Medal & T-Shirt</h3>
                <div class="committee-grid-v3">
                    <?php
                    include './data/2nd_convocation_data.php';


                    foreach ($Sub_Committee_for_Convocation_Dress as $member) {
                        echo '
                    <div class="committee-card-v3">
                        <img class="committee-img-v3" src="' . $member['img'] . '" alt="' . $member['name'] . '">
                        <div class="card-content-v3">
            ...
            <div class="committee-group-v3">
                <h3 class="committee-heading-v3">Sub-Committee for Registration & Coordination</h3>
                <div class="committee-grid-v3">
                    <?php
                    include './data/2nd_convocation_data.php';


                    foreach ($Sub_Committee_for_Registration_Coordination as $member) {
                        echo '
                    <div class="committee-card-v3">
                        <img class="committee-img-v3" src="' . $member['img'] . '" alt="' . $member['name'] . '">
                        <div class="card-content-v3">
            ...
            <div class="committee-group-v3">
                <h3 class="committee-heading-v3">Sub-Committee for Video Photography Multimedia & Media Coverage</h3>
                <div class="committee-grid-v3">
                    <?php
                    include './data/2nd_convocation_data.php';


                    foreach ($Sub_Committee_for_Video_Photography as $member) {
                        echo '
                    <div class="committee-card-v3">
                        <img class="committee-img-v3" src="' . $member['img'] . '" alt="' . $member['name'] . '">
                        <div class="card-content-v3">
            ...
            <div class="committee-group-v3">
                <h3 class="committee-heading-v3">Sub-Committee for Refreshment</h3>
                <div class="committee-grid-v3">
                    <?php
                    include './data/2nd_convocation_data.php';


                    foreach ($Sub_Committee_for_Refreshment as $member) {
                        echo '
                    <div class="committee-card-v3">
                        <img class="committee-img-v3" src="' . $member['img'] . '" alt="' . $member['name'] . '">
                        <div class="card-content-v3">
            ...
            <div class="committee-group-v3">
                <h3 class="committee-heading-v3">Sub-Committee for Awarding Certificate</h3>
                <div class="committee-grid-v3">
                    <?php
                    include './data/2nd_convocation_data.php';


                    foreach ($Sub_Committee_for_Awarding_Certificate as $member) {
                        echo '
                    <div class="committee-card-v3">
                        <img class="committee-img-v3" src="' . $member['img'] . '" alt="' . $member['name'] . '">
                        <div class="card-content-v3">
            ...
            <div class="committee-group-v3">
                <h3 class="committee-heading-v3"> Sub-Committee for Maintaining Discipline and Medical Aid</h3>
                <div class="committee-grid-v3">
                    <?php
                    include './data/2nd_convocation_data.php';


                    foreach ($Sub_Committee_for_Maintaining_Discipline_and_Medical_Aid as $member) {
                        echo '
                    <div class="committee-card-v3">
                        <img class="committee-img-v3" src="' . $member['img'] . '" alt="' . $member['name'] . '">
                        <div class="card-content-v3">
                    ...
                    ?>
                        ...
                        <div class="committee-group-v3">
                <h3 class="committee-heading-v3"> Sub-Committee for Finance</h3>
                <div class="committee-grid-v3">
                    <?php
                    include './data/2nd_convocation_data.php';


                    foreach ($Sub_Committee_for_Finance as $member) {
                        echo '
                    <div class="committee-card-v3">
                        <img class="committee-img-v3" src="' . $member['img'] . '" alt="' . $member['name'] . '">
                        <div class="card-content-v3">
                    ...
                    ?>
                                    ...
                                    <div class="committee-group-v3">
                <h3 class="committee-heading-v3">Sub-Committee for Convocation Procession Seating and Floor Management</h3>
                <div class="committee-grid-v3">
                    <?php
                    include './data/2nd_convocation_data.php';


                    foreach ($Sub_Committee_for_Convocation_Procession_Seating_and_Floor_Management as $member) {
                        echo '
                    <div class="committee-card-v3">
                        <img class="committee-img-v3" src="' . $member['img'] . '" alt="' . $member['name'] . '">
                        <div class="card-content-v3">
                ...
                <div class="committee-grid-v3">
                    ...
                    ?>
                                                            ...
                                                            <div class="committee-group-v3">
                <h3 class="committee-heading-v3">Volunteer Sub-Committee</h3>
                <div class="committee-grid-v3">
                    <?php
                    include './data/2nd_convocation_data.php';


                    foreach ($Volunteer_Sub_Committee as $member) {
                        echo '
                    <div class="committee-card-v3">
                        <img class="committee-img-v3" src="' . $member['img'] . '" alt="' . $member['name'] . '">
                        <div class="card-content-v3">
                    ...
                    ?>
                                                                        ...
                                                                        <div class="committee-group-v3">
                <h3 class="committee-heading-v3">Sub-Committee for Academic Costumes</h3>
                <div class="committee-grid-v3">
                    <?php
                    include './data/2nd_convocation_data.php';


                    foreach ($Sub_Committee_for_Academic_Costumes as $member) {
                        echo '
                    <div class="committee-card-v3">
                        <img class="committee-img-v3" src="' . $member['img'] . '" alt="' . $member['name'] . '">
                        <div class="card-content-v3">
