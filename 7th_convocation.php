...
<body class="bg-gray-100">
    ...
    <?php include("includes/nav.php"); ?>
        ...
        <div class="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <header class="mb-16">
                <p class="text-base font-semibold tracking-widest uppercase [color:rgb(135_37_141/var(--tw-text-opacity))] dark:[color:rgb(115_32_120/var(--tw-text-opacity))]">
                    A Defining Moment
                </p>
                <h2 class="text-6xl lg:text-7xl font-black text-gray-900 dark:text-white mt-1" data-aos="fade-right" data-aos-delay="150">
                    ...
                    <span class="[color:rgb(135_37_141/var(--tw-text-opacity))] dark:[color:rgb(115_32_120/var(--tw-text-opacity))]">
                        7<sup class="text-4xl align-super">th</sup>
                    </span>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
                ...
                <div class="lg:col-span-8" data-aos="fade-left" data-aos-delay="400">
                    ...
                    <h3 class="text-3xl font-bold [color:rgb(51_164_229/var(--tw-text-opacity))] dark:[color:rgb(43_138_192/var(--tw-text-opacity))] mb-6 border-b-2 border-gray-300 dark:border-gray-700 pb-3">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 program-list">
                        ...
                        <li data-aos="fade-up" data-aos-delay="500">
                            <a href="#gold-medalists"
                                class="flex items-center p-5 rounded-lg [background-color:rgb(106_33_112/var(--tw-bg-opacity))] dark:[background-color:rgb(115_32_120/var(--tw-bg-opacity))] text-white font-medium shadow-xl transition duration-300 transform hover:scale-[1.02] hover:[background-color:rgb(144_21_153/var(--tw-bg-opacity))] hover:[color:rgb(23_23_23/var(--tw-text-opacity))] group">
                                 <!-- Using SVG for Medal Icon -->
                                <span class="group-hover:text-gray-900 mr-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" 
                                        fill="currentColor" class="w-8 h-8 text-yellow-500 transition-all duration-300 group-hover:text-gray-900">
                        ...
                        <li data-aos="fade-up" data-aos-delay="800">
                            <a href="/souvenir/7th-Convocation.php" target="_blank" rel="noopener noreferrer"
                                class="flex items-center p-5 rounded-lg [background-color:rgb(106_33_112/var(--tw-bg-opacity))] dark:[background-color:rgb(115_32_120/var(--tw-bg-opacity))] text-white font-extrabold shadow-xl transition duration-300 transform hover:scale-[1.02] hover:[background-color:rgb(144_21_153/var(--tw-bg-opacity))] hover:[color:rgb(23_23_23/var(--tw-text-opacity))] group">
    ...
    <!-- <section class="convocation-section py-28 md:py-40 bg-gray-100 dark:bg-gray-900 relative overflow-hidden" data-aos="fade-up">
        ...
        <div class="absolute top-0 right-0 w-1/3 h-full 
            [background-color:rgb(51_164_229/var(--tw-bg-opacity))] 
            dark:[background-color:rgb(35_130_190/var(--tw-bg-opacity))] 
            transform skew-x-[-12deg] origin-top-right z-0"></div>
        ...
        <div class="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <header class="mb-16">
                ...
                <h2 class="text-6xl lg:text-7xl font-black text-gray-900 dark:text-white mt-1" data-aos="fade-right" data-aos-delay="150">
                    The <span class="[color:rgb(60_83_163/var(--tw-text-opacity))] dark:[color:rgb(45_65_135/var(--tw-text-opacity))]">7th</span> Convocation
                </h2>
            </header>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 program-list">
                        ...
                        <li data-aos="fade-up" data-aos-delay="400">
                            <a href="#gold-medalists"
                                ...
                                <span class="[color:rgb(60_83_163/var(--tw-text-opacity))] dark:[color:rgb(45_65_135/var(--tw-text-opacity))] text-3xl mb-1 block">🏆</span> Gold Medalists
                            </a>
                        </li>
                        ...
                        <li data-aos="fade-up" data-aos-delay="500">
                            <a href="#messages"
                                class="block p-6 rounded-lg bg-white dark:bg-gray-800 shadow-lg text-gray-800 dark:text-gray-200 font-semibold border-b-4 [border-color:rgb(69_156_217/var(--tw-bg-opacity))]  hover:[background-color:rgb(202_138_4/0.1)] dark:hover:[background-color:rgb(180_120_5/0.1)] transition duration-300 transform hover:-translate-y-1">
                                <span class="[color:rgb(60_83_163/var(--tw-text-opacity))] dark:[color:rgb(45_65_135/var(--tw-text-opacity))] text-3xl mb-1 block">🎙️</span> Dignitary SPEECHES
                            </a>
                        </li>
                        ...
                        <li data-aos="zoom-in" data-aos-delay="700">
                            <a href="/souvenir/8th-Convocation.php" target="_blank" rel="noopener noreferrer"
                                class="block w-full text-center py-4 rounded-lg [background-color:rgb(50_86_166/var(--tw-bg-opacity))] dark:[background-color:rgb(40_70_135/var(--tw-bg-opacity))] hover:[background-color:rgb(51_164_229/var(--tw-bg-opacity))] transition duration-300 font-bold text-xl text-white shadow-xl transform hover:-translate-y-1">
                ...
                <div class="lg:col-span-1 order-1 lg:order-2 self-stretch" data-aos="fade-left" data-aos-delay="200">
                    ...
                    <div class="p-8 [background-color:rgb(50_86_166/var(--tw-bg-opacity))] 
            dark:[background-color:rgb(40_70_135/var(--tw-bg-opacity))]  rounded-xl shadow-2xl h-full flex flex-col justify-between">

                        <div>
                            <h3 class="text-xl font-light uppercase tracking-wider text-white mb-2">Ceremony Date</h3>
    ...
    <!-- <section class="convocation-section py-20 lg:py-32 bg-white dark:bg-gray-900" data-aos="fade-up">
        <div class="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <header class="text-center mb-16">
                ...
                <h2 class="text-5xl lg:text-6xl font-extrabold text-gray-800 dark:text-white mt-1" data-aos="fade-down" data-aos-delay="150">
                    The <span class="inline-flex items-start"><span>7</span><sup class="text-2xl ml-0.5">th</sup></span> Convocation
                </h2>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
                ...
                <div class="lg:col-span-1" data-aos="fade-right" data-aos-delay="300">
                    <div class="p-8 border-l-4 border-blue-600 bg-gray-50 dark:bg-gray-800 shadow-lg rounded-lg h-full">
                        <h3 class="text-3xl font-serif font-bold text-gray-900 dark:text-white mb-4">
                            Date of Ceremony
                        </h3>
                        <p class="text-4xl font-extrabold text-blue-600 mb-6 border-b pb-3 border-gray-200 dark:border-gray-700">
                            27th February, 2024
                        </p>
                ...
                <div class="lg:col-span-1 flex justify-center order-first lg:order-none p-4" data-aos="zoom-in" data-aos-delay="400">
                    <img src="./img/All convocation logo/7th.png" alt="7th Convocation Logo"
                        class="w-full max-w-sm rounded-full border-8 border-gray-200 dark:border-gray-700 shadow-2xl transition duration-500 ease-in-out hover:border-blue-600 bg-white dark:bg-gray-800 p-2"
                ...
                <div class="lg:col-span-1" data-aos="fade-left" data-aos-delay="500">
                    ...
                    <ul class="space-y-3 program-list">
                        ...
                        <li data-aos="zoom-in" data-aos-delay="900" class="pt-4">
                            <a href="/souvenir/8th-Convocation.php" target="_blank" rel="noopener noreferrer"
                                class="block w-full text-center py-4 rounded-lg bg-blue-600 hover:bg-blue-400 transition duration-300 font-semibold text-white shadow-md transform hover:-translate-y-1">
        ...
        <div class="container mx-auto max-w-7xl">
            ...
            <div class="message-card-grid">
                ...
                include './data/7th_convocation_data.php';
                $delay = 0;
...
<script>
    ...
    function openMessage(index) {
        ...
        // Helper function to safely set or hide elements
        function setOrHide(id, value, isImage = false) {
        ...
        // Apply to each modal field
        setOrHide('modalImg', data.img, true);
        setOrHide('modalLogo', data.logo, true);
        setOrHide('modalName', data.name);
        setOrHide('modalTitle', data.title);
        setOrHide('modalDept', data.dept);
        setOrHide('modalOrg', data.org);
        setOrHide('modalMsg', data.msg);

        // Justify text for message content
